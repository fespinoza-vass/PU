...
class AgreementStatus extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $status = $this->adobeSignApiService->getAgreementSignStatus($quote['agreement_id']);

        $resultJson = $this->resultFactory->create(ResultFactory::TYPE_JSON);
        $resultJson->setData(["status" => $status]);
        return $resultJson;
    }
}
