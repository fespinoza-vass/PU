 ...
 */
class GuestHighlightProduct implements ResolverInterface
{
    /**
    ...
    {
        return $this->guestHighlightManagement->getHighlight(GuestHighlightManagementInterface::PAGE_PRODUCT);
    }
}
