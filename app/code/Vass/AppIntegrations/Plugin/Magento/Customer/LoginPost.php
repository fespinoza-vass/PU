...
use Magento\Customer\Controller\Account\LoginPost as ParentClass;
...
class LoginPost
{
    ...
    public function afterExecute(
        ...
        $url = $this->storeManager->getStore()->getBaseUrl() . 'customer/app/login?mobile=' . strtolower($platform);
        $result->setUrl($url);
        return $result;
    }
}
