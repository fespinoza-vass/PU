...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            links: {
                "visibleShipping":'checkout:isVisibleShipping',
                "ruc":'checkout.steps.billing-step.payment.beforeMethods.invoice-form.custom-checkout-form-fieldset.ruc:value',
                "razonSocial":'checkout.steps.billing-step.payment.beforeMethods.invoice-form.custom-checkout-form-fieldset.razon_social:value',
                "direccionFiscal":'checkout.steps.billing-step.payment.beforeMethods.invoice-form.custom-checkout-form-fieldset.direccion_fiscal:value'
            },
        },
        visibleShipping: ko.observable(),
        ruc: ko.observable(),
        razonSocial: ko.observable(),
        direccionFiscal: ko.observable(),

        initialize: function () {
            this._super();

            this.visibleShipping.subscribe(function (value) {
                this.resetInvoiceForm(value);
            },this);
        ...
        /**
         * Reset inputs values invoice form
         * @param value
         */
        resetInvoiceForm: function (value){
            if(value == true){
                this.ruc('');
                this.razonSocial('');
