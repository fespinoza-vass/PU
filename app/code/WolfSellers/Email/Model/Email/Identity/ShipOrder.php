...
class ShipOrder extends Identity
{
    /** @var string */
    const XML_PATH_EMAIL_ENABLED = 'bopis/ship_email/enabled';

    /** @var string */
    const XML_PATH_EMAIL_TEMPLATE = 'bopis/ship_email/template';

    /** @var string */
    const XML_PATH_EMAIL_IDENTITY = 'bopis/ship_email/identity';
