...
namespace WolfSellers\EnvioRapido\Setup\Patch\Data;
...
class HorarioDisponibleAddressAttribute implements DataPatchInterface, PatchRevertableInterface
{
    const ATTRIBUTE_CODE = 'horarios_disponibles';
