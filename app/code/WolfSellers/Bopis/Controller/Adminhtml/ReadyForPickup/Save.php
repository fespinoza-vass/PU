...
namespace WolfSellers\Bopis\Controller\Adminhtml\ReadyForPickup;
...
class Save extends Order
{
    ...
    public function execute()
    {
        ...
        if (!$this->isValidPostRequest()) {
            $this->messageManager->addErrorMessage(__('No se pudo preparar la orden para recojo.'));
        ...
        if ($order) {
            try {
                $order->setStatus($this->config->getConfig('bopis/status/readyforpickup'))
