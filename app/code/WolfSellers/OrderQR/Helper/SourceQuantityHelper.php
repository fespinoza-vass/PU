...
class SourceQuantityHelper extends AbstractHelper
{
    ...
    protected $_sourceRepositoryInterface;
    ...
    public function __construct(
        ...
        $this->_sourceRepositoryInterface = $sourceRepository;
    ...
    public function getStockBySource($sku, $sourceCode){
        $source = $this->_sourceRepositoryInterface->get($sourceCode);
        return $this->_inventoryBySource->getSalableQtyBySource($sku,$source);
    }
