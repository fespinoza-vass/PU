...
class Orders extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        \Magento\Sales\Model\OrderFactory $orderModel = null
    ) {
        ...
        $this->orderStatus = $orderStatus ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(OrderStatus::class);
        ...
        $this->saleperpartnerFactory = $saleperpartnerFactory ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(SaleperpartnerFactory::class);
        $this->sellertransactionFactory = $sellertransactionFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->create(SellertransactionFactory::class);
        $this->feedbackcountFactory = $feedbackcountFactory ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(FeedbackcountFactory::class);
        ...
        $this->orderModel = $orderModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Sales\Model\OrderFactory::class);
