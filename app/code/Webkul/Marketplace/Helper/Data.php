...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        ControllersRepository $controllersRepository = null,
        UrlRewriteFactory $urlRewriteFactory = null,
        \Webkul\Marketplace\Logger\Logger $logger = null,
        ...
        $this->visibility = $visibility ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(Visibility::class);
        $this->controllersRepository = $controllersRepository ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(ControllersRepository::class);
        ...
        $this->logger = $logger ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Webkul\Marketplace\Logger\Logger::class);
