...
class ProductListStatus implements OptionSourceInterface
{
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\Product\Attribute\Source\Status $productStatus = null
    ) {
        $this->marketplaceHelper = $marketplaceHelper;
        $this->productStatus = $productStatus ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Catalog\Model\Product\Attribute\Source\Status::class);
    }
