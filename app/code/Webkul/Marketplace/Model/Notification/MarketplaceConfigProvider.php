...
class MarketplaceConfigProvider
{
    ...
    public function __construct(
        ...
        \Webkul\Marketplace\Model\ProductFactory $productModel = null,
        \Webkul\Marketplace\Model\SellerFactory $sellerModel = null,
        \Magento\Customer\Model\CustomerFactory $customerModel = null,
        \Magento\Catalog\Model\ProductFactory $productFactory = null,
        \Webkul\Marketplace\Model\FeedbackFactory $feedbackFactory = null
    ) {
        ...
        $this->sellerModel = $sellerModel?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Webkul\Marketplace\Model\SellerFactory::class);
        ...
        $this->feedbackFactory = $feedbackFactory?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Webkul\Marketplace\Model\FeedbackFactory::class);
    }
    /**
     * {@inheritdoc}
     */
