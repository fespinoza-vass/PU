...
class Save extends \Magento\Customer\Controller\AbstractAccount
{
    ...
    public function __construct(
        ...
        EavAttribute $eavAttribute = null,
        ...
        $this->attributeCollection = $attributeCollection ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(AttributeCollection::class);
        $this->eavAttribute = $eavAttribute ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(EavAttribute::class);
        $this->productUrl = $productUrl ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(ProductUrl::class);
        $this->entityModel = $entityModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(EntityModel::class);
        parent::__construct(
            $context
        );
    }
