...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $this->mpOrderModel = $mpOrderModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(MpOrderModel::class);
        $this->creditmemoModel = $creditmemoModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(Creditmemo::class);
        $this->creditmemoItem = $creditmemoItem ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Sales\Model\Order\Creditmemo\ItemFactory::class);
        $this->invoiceModel = $invoiceModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(InvoiceFactory::class);
        ...
        $this->productRepository = $productRepository ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(ProductRepositoryInterfaceFactory::class);
        $this->shippingConfig = $shippingConfig ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Shipping\Model\Config::class);
        $this->carrierFactory = $carrierFactory ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Magento\Shipping\Model\CarrierFactory::class);
        $this->itemCollectionFactory = $itemCollectionFactory ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(OrderItemCollection::class);
