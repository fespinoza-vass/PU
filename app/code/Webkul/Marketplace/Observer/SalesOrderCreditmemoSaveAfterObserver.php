...
class SalesOrderCreditmemoSaveAfterObserver implements ObserverInterface
{
    ...
    public function __construct(
        ...
        SalesListCollection $salesListCollection = null,
        ...
        $this->_date = $date;
        $this->salesListCollection = $salesListCollection ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(SalesListCollection::class);
