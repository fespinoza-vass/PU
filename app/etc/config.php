...
return [
    ...
    'modules' => [
        ...
        'WolfSellers_AmastyLabel' => 1,
        'WolfSellers_AmastyMegaMenu' => 1,
        'WolfSellers_Backend' => 1,
        'WolfSellers_BackendBopis' => 0,
        'WolfSellers_Bopis' => 1,
        'WolfSellers_Checkout' => 1,
        'WolfSellers_Consecutive' => 1,
        'WolfSellers_CustomForm' => 1,
        'WolfSellers_CustomSwatch' => 1,
        'WolfSellers_Customer' => 1,
        'WolfSellers_DiorMenu' => 1,
        'WolfSellers_DireccionesTiendas' => 1,
        'WolfSellers_Email' => 1,
        'WolfSellers_EnableDisableTfa' => 1,
        'WolfSellers_EnvioRapido' => 1,
        'WolfSellers_Urbano' => 1,
        'WolfSellers_Flow' => 1,
        'WolfSellers_FreeGiftBanner' => 1,
        'WolfSellers_FreeShipping' => 1,
        'WolfSellers_GoogleTagManager' => 1,
        'WolfSellers_InStorePickup' => 1,
        'WolfSellers_InventoryReservationBySource' => 1,
        'WolfSellers_LoginUser' => 1,
        'WolfSellers_OrderManagement' => 1,
        'WolfSellers_OrderQR' => 1,
        'WolfSellers_OrderTracking' => 1,
        'WolfSellers_PageBuilder' => 1,
        'WolfSellers_Recategorizar' => 1,
        'WolfSellers_Reports' => 1,
        'WolfSellers_Sales' => 1,
        'WolfSellers_SalesOrder' => 1,
        'WolfSellers_SalesRule' => 1,
        'WolfSellers_ShippingStepMessages' => 1,
        'WolfSellers_SkinCare' => 1,
        'WolfSellers_Sources' => 1,
        'WolfSellers_FastShipping' => 1,
        'WolfSellers_Wishlist' => 1,
        'WolfSellers_ZipCode' => 1
    ],
    'admin_user' => [
        'locale' => [
            'code' => [
